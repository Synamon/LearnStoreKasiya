 ...
 */
public class LessonContentFrag4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tvTitle.setText(R.string.quadraticLesson4Title);
        tvDisplayContent.setText(R.string.quadraticLesson4TDisplay);
        tvLessonText.setText(R.string.quadraticLesson4Text);
